...
In this blog post, we'll showcase our approach to the tornado peril and how it is applied using data engineering and we share how we apply it in a business setting.
...
3. Below, we apply  high resolution annual probabilities into common equations performed by actuaries and underwriters.
...
[^1] 1. Rejda, G. E., & McNamara, M. J. (2021). Principles of Risk Management and Insurance (14th ed.). Pearson.